...
if [[ use_local_maven_cache -eq 1 ]] ; then
	...
	mvn -q dependency:get \
			-Dartifact=org.edu_sharing:edu_sharing-community-deploy-installer-services-rendering-distribution:${org.edu_sharing:edu_sharing-community-deploy-installer-services-rendering-distribution:tar.gz:bin.version}:tar.gz:bin \
...
rm edu_sharing-community-deploy-installer-services-rendering-distribution-${org.edu_sharing:edu_sharing-community-deploy-installer-services-rendering-distribution:tar.gz:bin.version}-bin.tar.gz
