 ...
 * @since 4.0
 */
public class SOLRAPIClient2
{
    protected final static Logger log = LoggerFactory.getLogger(SOLRAPIClient2.class);
    ...
    public SOLRAPIClient2(AlfrescoHttpClient repositoryHttpClient,
    ...
    private PropertyValue getSinglePropertyValue(DataTypeDefinition dataType, Object value) throws JSONException
    {
        ...
        else if(dataTypeName.equals(DataTypeDefinition.MLTEXT))
        {
        	...
        	if (value instanceof String) {
        		value = new JSONObject(new JSONTokener("{a:" + value + "}")).getJSONArray("a");
        	}
        	// fix: end
