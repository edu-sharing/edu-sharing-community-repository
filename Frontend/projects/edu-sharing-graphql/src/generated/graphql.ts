...
export type MetadatasQueryVariables = Exact<{
  ids?: InputMaybe<Array<Scalars['ID']> | Scalars['ID']>;
}>;


export type MetadatasQuery = { __typename?: 'Query', metadatas: Array<(
    { __typename?: 'Metadata' }
    & BaseMetadataFragment
  ) | null> };

export type SuggestionsMutationVariables = Exact<{
  suggestion: SuggestionInput;
}>;


export type SuggestionsMutation = { __typename?: 'Mutation', addOrUpdateSuggestion: boolean };

export type BaseMetadataFragment = { __typename?: 'Metadata', id: string, nodeType: string, info?: { __typename?: 'Info', aspects?: Array<string> | null, metadataSet?: string | null, objectType?: { __typename?: 'RangedValue', id?: string | null } | null } | null };

export const BaseMetadataFragmentDoc = gql`
    fragment BaseMetadata on Metadata {
  id
  nodeType
  info {
    aspects
...
export const MetadatasDocument = gql`
    query metadatas($ids: [ID!]) {
  metadatas(input: {ids: $ids}) {
    ...BaseMetadata
  }
}
    ${BaseMetadataFragmentDoc}`;

  @Injectable({
    providedIn: 'root'
  })
  export class MetadatasGQL extends Apollo.Query<MetadatasQuery, MetadatasQueryVariables> {
    document = MetadatasDocument;
...
export const SuggestionsDocument = gql`
    mutation suggestions($suggestion: SuggestionInput!) {
  ...
  export class SuggestionsGQL extends Apollo.Mutation<SuggestionsMutation, SuggestionsMutationVariables> {
    document = SuggestionsDocument;
