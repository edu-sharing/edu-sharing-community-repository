...
export type MetadatasQuery = {
    __typename?: 'Query';
    metadatas: Array<({ __typename?: 'Metadata' } & BaseMetadataFragment) | null>;
};
...
export type BaseMetadataFragment = {
    __typename?: 'Metadata';
    id: string;
    nodeType: string;
    info?: {
        ...
        objectType?: { __typename?: 'RangedValue'; id?: string | null } | null;
    } | null;
};
...
export class SuggestionsGQL extends Apollo.Mutation<
    SuggestionsMutation,
    SuggestionsMutationVariables
> {
