export class RestConstants {
    ...
    public static METADATASET_DEFAULT_ID = 'default';
    ...
    public static TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SHARE =
        'TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SHARE';
    public static TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_FUZZY =
        'TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_FUZZY';
    public static TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SAFE =
        'TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SAFE';
    public static TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SHARE_SAFE =
        'TOOLPERMISSION_GLOBAL_AUTHORITY_SEARCH_SHARE_SAFE';
    ...
    public static TOOLPERMISSION_CREATE_ELEMENTS_ASSIGNMENTS =
        'TOOLPERMISSION_CREATE_ELEMENTS_ASSIGNMENTS';
    public static TOOLPERMISSION_CREATE_ELEMENTS_FILES = 'TOOLPERMISSION_CREATE_ELEMENTS_FILES';
    public static TOOLPERMISSION_CREATE_ELEMENTS_COLLECTIONS =
    ...
    public static TOOLPERMISSION_EDITORIAL_SUGGESTIONS = 'TOOLPERMISSION_EDITORIAL_SUGGESTIONS';
    public static TOOLPERMISSION_COLLECTION_CURRICULUM = 'TOOLPERMISSION_COLLECTION_CURRICULUM';
    public static TOOLPERMISSION_METADATA_METHODOLOGY = 'TOOLPERMISSION_METADATA_METHODOLOGY';
    public static TOOLPERMISSION_COLLECTION_PINNING = 'TOOLPERMISSION_COLLECTION_PINNING';
    public static TOOLPERMISSION_ADD_TO_PUBLIC_COLLECTION =
        'TOOLPERMISSION_ADD_TO_PUBLIC_COLLECTION';
    public static TOOLPERMISSION_COLLECTION_FEEDBACK = 'TOOLPERMISSION_COLLECTION_FEEDBACK';
    public static TOOLPERMISSION_MATERIAL_FEEDBACK = 'TOOLPERMISSION_MATERIAL_FEEDBACK';
    ...
    public static TOOLPERMISSION_RATE_READ = 'TOOLPERMISSION_RATE_READ';
    public static TOOLPERMISSION_RATE_WRITE = 'TOOLPERMISSION_RATE_WRITE';
    public static TOOLPERMISSION_SUGGESTION_READ = 'TOOLPERMISSION_SUGGESTION_READ';
    public static TOOLPERMISSION_SUGGESTION_WRITE = 'TOOLPERMISSION_SUGGESTION_WRITE';
    public static TOOLPERMISSION_SIGNUP_GROUP = 'TOOLPERMISSION_SIGNUP_GROUP';
    public static TOOLPERMISSION_COLLECTION_PROPOSAL = 'TOOLPERMISSION_COLLECTION_PROPOSAL';
    ...
    public static CONTRIBUTOR_ROLES_LIFECYCLE = [
        'author',
        'publisher',
        'unknown',
        'initiator',
