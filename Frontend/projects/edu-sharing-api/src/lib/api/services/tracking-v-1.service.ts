...
export class TrackingV1Service extends BaseService {
  ...
  trackEvent$Response(params: {
     ...
     */
    event: 'DOWNLOAD_MATERIAL' | 'VIEW_MATERIAL' | 'VIEW_MATERIAL_EMBEDDED' | 'VIEW_MATERIAL_PLAY_MEDIA' | 'LOGIN_USER_SESSION' | 'LOGIN_USER_OAUTH_PASSWORD' | 'LOGIN_USER_OAUTH_REFRESH_TOKEN' | 'LOGOUT_USER_TIMEOUT' | 'LOGOUT_USER_REGULAR';
