...
export class MediacenterV1Service extends BaseService {
  ...
  importMcOrgConnections$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.ImportMcOrgConnectionsPath, 'post');
    if (params) {
      rb.query('removeSchoolsFromMC', params.removeSchoolsFromMC, {"style":"form","explode":true});
  ...
  importMediacenters$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.ImportMediacentersPath, 'post');
    if (params) {
      rb.body(params.body, 'multipart/form-data');
    }
  ...
  importMediacenters(params: {
    ...
    return this.importMediacenters$Response(params).pipe(
      map((r: StrictHttpResponse<MediacentersImportResult>) => r.body as MediacentersImportResult)
    );
  }
  ...
  importOrganisations$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.ImportOrganisationsPath, 'post');
    if (params) {
      rb.body(params.body, 'multipart/form-data');
    }
  ...
  importOrganisations(params: {
    ...
    return this.importOrganisations$Response(params).pipe(
      map((r: StrictHttpResponse<OrganisationsImportResult>) => r.body as OrganisationsImportResult)
    );
  }
  ...
  getMediacenters$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.GetMediacentersPath, 'get');
    if (params) {
  ...
  editMediacenter$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.EditMediacenterPath, 'put');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
   ...
   */
  static readonly CreateMediacenterPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}';
  ...
  createMediacenter$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.CreateMediacenterPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('mediacenter', params.mediacenter, {"style":"simple","explode":false});
      rb.body(params.body, 'application/json');
   ...
   */
  static readonly DeleteMediacenterPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}';
  ...
  deleteMediacenter$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.DeleteMediacenterPath, 'delete');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('mediacenter', params.mediacenter, {"style":"simple","explode":false});
    }
   ...
   */
  static readonly GetMediacenterLicensedNodesPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}/licenses';
  ...
  getMediacenterLicensedNodes$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.GetMediacenterLicensedNodesPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
   ...
   */
  static readonly GetMediacenterGroupsPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}/manages';
  ...
  getMediacenterGroups$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.GetMediacenterGroupsPath, 'get');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('mediacenter', params.mediacenter, {"style":"simple","explode":false});
    }
   ...
   */
  static readonly AddMediacenterGroupPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}/manages/{group}';
  ...
  addMediacenterGroup$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.AddMediacenterGroupPath, 'put');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('mediacenter', params.mediacenter, {"style":"simple","explode":false});
   ...
   */
  static readonly RemoveMediacenterGroupPath = '/mediacenter/v1/mediacenter/{repository}/{mediacenter}/manages/{group}';
  ...
  removeMediacenterGroup$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, MediacenterV1Service.RemoveMediacenterGroupPath, 'delete');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('mediacenter', params.mediacenter, {"style":"simple","explode":false});
      rb.path('group', params.group, {"style":"simple","explode":false});
