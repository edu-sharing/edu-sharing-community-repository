...
export class RatingV1Service extends BaseService {
    ...
    /**
     * Path part for operation getAccumulatedRatings
     */
    static readonly GetAccumulatedRatingsPath = '/rating/v1/ratings/{repository}/{node}/history';
     ...
     *
     * This method provides access to the full `HttpResponse`, allowing access to response headers.
     * To access only the response body, use `getAccumulatedRatings()` instead.
     *
     * This method doesn't expect any request body.
     */
    getAccumulatedRatings$Response(params: {
        /**
         * ID of repository (or &quot;-home-&quot; for home repository)
         */
        repository: string;
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            RatingV1Service.GetAccumulatedRatingsPath,
            'get',
        );
        if (params) {
            rb.path('repository', params.repository, {});
     ...
     *
     * This method provides access to only to the response body.
     * To access the full response (for headers, for example), `getAccumulatedRatings$Response()` instead.
     *
     * This method doesn't expect any request body.
     */
    getAccumulatedRatings(params: {
        /**
         * ID of repository (or &quot;-home-&quot; for home repository)
         */
        repository: string;
        ...
        return this.getAccumulatedRatings$Response(params).pipe(
     ...
     */
    static readonly GetNodesAlteredInRangePath = '/rating/v1/ratings/{repository}/nodes/altered';
    ...
    getNodesAlteredInRange$Response(params: {
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            RatingV1Service.GetNodesAlteredInRangePath,
            'get',
        );
        if (params) {
            rb.path('repository', params.repository, {});
