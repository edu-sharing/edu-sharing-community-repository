...
[key: string]: Array<string>;
   ...
   */
  static readonly ChangeMetadataWithVersioningPath = '/node/v1/nodes/{repository}/{node}/metadata';
...
[key: string]: Array<string>;
    ...
    const rb = new RequestBuilder(this.rootUrl, NodeV1Service.ChangeMetadataWithVersioningPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('node', params.node, {"style":"simple","explode":false});
      rb.query('versionComment', params.versionComment, {"style":"form","explode":true});
...
[key: string]: Array<string>;
   ...
   */
  static readonly GetTemplateMetadataPath = '/node/v1/nodes/{repository}/{node}/metadata/template';
   ...
   */
  static readonly ChangeTemplateMetadataPath = '/node/v1/nodes/{repository}/{node}/metadata/template';
...
[key: string]: Array<string>;
    ...
    const rb = new RequestBuilder(this.rootUrl, NodeV1Service.ChangeTemplateMetadataPath, 'put');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('node', params.node, {"style":"simple","explode":false});
...
[key: string]: Array<string>;
   ...
   */
  static readonly RevertVersionPath = '/node/v1/nodes/{repository}/{node}/versions/{major}/{minor}/_revert';
   ...
   */
  static readonly GetVersionMetadataPath = '/node/v1/nodes/{repository}/{node}/versions/{major}/{minor}/metadata';
  ...
  getWorkflowHistory(params: {
    ...
    return this.getWorkflowHistory$Response(params).pipe(
      map((r: StrictHttpResponse<Array<WorkflowHistory>>) => r.body as Array<WorkflowHistory>)
    );
  }
