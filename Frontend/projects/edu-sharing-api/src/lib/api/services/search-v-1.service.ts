...
export class SearchV1Service extends BaseService {
  ...
  searchByProperty$Response(params: {
     ...
     * Type of element
     */
    contentType?: 'FILES' | 'FOLDERS' | 'FILES_AND_FOLDERS' | 'COLLECTIONS' | 'TOOLPERMISSIONS' | 'ALL';
  ...
  searchContributor$Response(params: {
    ...
    if (params) {
      ...
      rb.query('contributorProperties', params.contributorProperties, {"style":"form","explode":true});
    }
