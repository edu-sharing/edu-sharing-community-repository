...
export class AuthenticationV1Service extends BaseService {
  ...
  authenticate$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AuthenticationV1Service.AuthenticatePath, 'post');
    if (params) {
  ...
  hasAccessToScope$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AuthenticationV1Service.HasAccessToScopePath, 'get');
    if (params) {
  ...
  loginToScope$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AuthenticationV1Service.LoginToScopePath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
