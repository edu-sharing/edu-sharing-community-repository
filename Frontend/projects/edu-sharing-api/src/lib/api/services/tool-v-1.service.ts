...
[key: string]: Array<string>;
    ...
    const rb = new RequestBuilder(this.rootUrl, ToolV1Service.CreateToolDefintitionPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
...
[key: string]: Array<string>;
   ...
   */
  static readonly CreateToolInstancePath = '/tool/v1/tools/{repository}/{toolDefinition}/toolinstances';
