...
[key: string]: {
  ...
  refreshEduGroupCache$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AdminV1Service.RefreshEduGroupCachePath, 'post');
    if (params) {
   ...
   * This method doesn't expect any request body.
   */
  getCatalinaOut$Response(params?: {
   ...
   * This method doesn't expect any request body.
   */
  getCluster$Response(params?: {
  }): Observable<StrictHttpResponse<CacheCluster>> {
   ...
   * This method doesn't expect any request body.
   */
  getGlobalGroups$Response(params?: {
  ...
  importOai$Response(params: {
    ...
    if (params) {
      ...
      rb.query('importerClassName', params.importerClassName, {"style":"form","explode":true});
      rb.query('recordHandlerClassName', params.recordHandlerClassName, {"style":"form","explode":true});
      rb.query('binaryHandlerClassName', params.binaryHandlerClassName, {"style":"form","explode":true});
      rb.query('persistentHandlerClassName', params.persistentHandlerClassName, {"style":"form","explode":true});
...
[key: string]: string;
  ...
  }): Observable<StrictHttpResponse<Array<JobInfo>>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllJobs$Response(params?: {
  }): Observable<StrictHttpResponse<Array<JobDescription>>> {
   ...
   */
  getAllJobs(params?: {
  }): Observable<Array<JobDescription>> {
   ...
   * This method doesn't expect any request body.
   */
  refreshAppInfo$Response(params?: {
  }): Observable<StrictHttpResponse<void>> {
   ...
   * This method doesn't expect any request body.
   */
  getConfig$Response(params?: {
  }): Observable<StrictHttpResponse<RepositoryConfig>> {
   ...
   * This method doesn't expect any request body.
   */
  serverUpdateList$Response(params?: {
   ...
   * This method doesn't expect any request body.
   */
  serverUpdateList(params?: {
  }): Observable<Array<ServerUpdateInfo>> {

    return this.serverUpdateList$Response(params).pipe(
      map((r: StrictHttpResponse<Array<ServerUpdateInfo>>) => r.body as Array<ServerUpdateInfo>)
    );
  }
  ...
  }): Observable<StrictHttpResponse<AdminStatistics>> {
...
[key: string]: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AdminV1Service.GetAllToolpermissionsPath, 'get');
    if (params) {
