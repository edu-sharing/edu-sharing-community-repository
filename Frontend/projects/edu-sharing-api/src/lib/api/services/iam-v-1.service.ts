...
export class IamV1Service extends BaseService {
  ...
  signupGroup$Response(params: {
     ...
     */
    password?: string;
  }): Observable<StrictHttpResponse<'InvalidPassword' | 'AlreadyInList' | 'AlreadyMember' | 'Ok'>> {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<'InvalidPassword' | 'AlreadyInList' | 'AlreadyMember' | 'Ok'>;
      })
    );
  }
  ...
  signupGroup(params: {
    ...
    return this.signupGroup$Response(params).pipe(
      map((r: StrictHttpResponse<'InvalidPassword' | 'AlreadyInList' | 'AlreadyMember' | 'Ok'>) => r.body as 'InvalidPassword' | 'AlreadyInList' | 'AlreadyMember' | 'Ok')
    );
  }
   ...
   */
  static readonly RemoveNodeListPath = '/iam/v1/people/{repository}/{person}/nodeList/{list}/{node}';
