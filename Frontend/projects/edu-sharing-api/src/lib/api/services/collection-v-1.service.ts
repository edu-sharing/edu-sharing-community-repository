...
export class CollectionV1Service extends BaseService {
   ...
   */
  static readonly GetCollectionsContainingProposalsPath = '/collection/v1/collections/{repository}/children/proposals/collections';
  ...
  getCollectionsContainingProposals$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.GetCollectionsContainingProposalsPath, 'get');
    if (params) {
  ...
  getCollectionsContainingProposals(params: {
    ...
    return this.getCollectionsContainingProposals$Response(params).pipe(
      map((r: StrictHttpResponse<CollectionProposalEntries>) => r.body as CollectionProposalEntries)
    );
  }
  ...
  setPinnedCollections$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.SetPinnedCollectionsPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
  ...
  updateCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.UpdateCollectionPath, 'put');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.body(params.body, 'application/json');
    }
  ...
  deleteCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.DeleteCollectionPath, 'delete');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
    }
   ...
   */
  static readonly CreateCollectionPath = '/collection/v1/collections/{repository}/{collection}/children';
  ...
  createCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.CreateCollectionPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.body(params.body, 'application/json');
   ...
   */
  static readonly GetCollectionsSubcollectionsPath = '/collection/v1/collections/{repository}/{collection}/children/collections';
  ...
  getCollectionsSubcollections$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.GetCollectionsSubcollectionsPath, 'get');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
   ...
   */
  static readonly GetCollectionsProposalsPath = '/collection/v1/collections/{repository}/{collection}/children/proposals';
  ...
  getCollectionsProposals$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.GetCollectionsProposalsPath, 'get');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.query('status', params.status, {"style":"form","explode":true});
   ...
   */
  static readonly GetCollectionsReferencesPath = '/collection/v1/collections/{repository}/{collection}/children/references';
  ...
  getCollectionsReferences$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.GetCollectionsReferencesPath, 'get');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.query('maxItems', params.maxItems, {"style":"form","explode":true});
   ...
   */
  static readonly GetFeedbackOfCollectionPath = '/collection/v1/collections/{repository}/{collection}/feedback';
  ...
  getFeedbackOfCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.GetFeedbackOfCollectionPath, 'get');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
    }
  ...
  getFeedbackOfCollection(params: {
    ...
    return this.getFeedbackOfCollection$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CollectionFeedback>>) => r.body as Array<CollectionFeedback>)
    );
  }
   ...
   */
  static readonly AddFeedbackToCollectionPath = '/collection/v1/collections/{repository}/{collection}/feedback';
...
[key: string]: Array<string>;
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.AddFeedbackToCollectionPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.body(params.body, 'application/json');
...
[key: string]: Array<string>;
   ...
   */
  static readonly ChangeIconOfCollectionPath = '/collection/v1/collections/{repository}/{collection}/icon';
  ...
  changeIconOfCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.ChangeIconOfCollectionPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
   ...
   */
  static readonly RemoveIconOfCollectionPath = '/collection/v1/collections/{repository}/{collection}/icon';
  ...
  removeIconOfCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.RemoveIconOfCollectionPath, 'delete');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
    }
   ...
   */
  static readonly SetCollectionOrderPath = '/collection/v1/collections/{repository}/{collection}/order';
  ...
  setCollectionOrder$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.SetCollectionOrderPath, 'post');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.body(params.body, 'application/json');
   ...
   */
  static readonly AddToCollectionPath = '/collection/v1/collections/{repository}/{collection}/references/{node}';
   ...
   */
  static readonly DeleteFromCollectionPath = '/collection/v1/collections/{repository}/{collection}/references/{node}';
  ...
  deleteFromCollection$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CollectionV1Service.DeleteFromCollectionPath, 'delete');
    if (params) {
      rb.path('repository', params.repository, {"style":"simple","explode":false});
      rb.path('collection', params.collection, {"style":"simple","explode":false});
      rb.path('node', params.node, {"style":"simple","explode":false});
