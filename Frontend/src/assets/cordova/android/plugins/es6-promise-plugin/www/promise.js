                        ...
                        !(function (t, r) {
                            ...
                            function p() {
                                try {
                                    var e = t,
                                        n = e('vertx');
                                    return (I = n.runOnLoop || n.runOnContext), c();
                                } catch (r) {
                                    return l();
                                }
                            }
                            ...
                            function x(t, e) {
                                t._state === re && ((t._state = ie), (t._result = e), Q(S, t));
                            }
                            function O(t, e, n, r) {
            ...
            3: [
                function (t, e) {
                    ...
                    function u() {
                        v &&
                            p &&
                            ((v = !1), p.length ? (d = p.concat(d)) : (y = -1), d.length && s());
                    }
                    function s() {
                        if (!v) {
                            var t = o(u);
