...
<<<<<<<< HEAD:config/defaults/src/main/resources/metadatasets/MetadataReader.java
				return mdsCache.get(id);
========
                return SerializationUtils.clone(mdsCache.get(id));
>>>>>>>> maven/fixes/7.0:Backend/alfresco/module/src/main/java/org/edu_sharing/metadataset/v2/MetadataReader.java
