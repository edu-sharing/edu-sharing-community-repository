...
import org.alfresco.solr.AlfrescoUpdateHandler;
...
import static org.edu_sharing.solr.ReplicationHandler.*;
 ...
 * master. </p>
 *
 * @version $Id: SnapPuller.java 819336 2009-09-27 16:37:40Z yonik $
 * @since solr 1.4
 */
public class SnapPuller {
  ...
  private void doCommit() throws IOException {
    ...
    }else if(solrCore.getUpdateHandler() instanceof AlfrescoUpdateHandler){
    	LOG.info("Edu-Sharing Customization allow AlfrescoUpdateHandler! Force open index writer to make sure older index files get deleted");
    	AlfrescoUpdateHandler handler = (AlfrescoUpdateHandler) solrCore.getUpdateHandler();
        handler.forceOpenWriter();
        replicationHandler.refreshCommitpoint();
    } else  {
