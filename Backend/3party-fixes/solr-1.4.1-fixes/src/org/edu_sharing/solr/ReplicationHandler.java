...
public class ReplicationHandler extends RequestHandlerBase implements SolrCoreAware {
  ...
  public String getSource() {
    return "$URL: https://svn.apache.org/repos/asf/lucene/solr/branches/branch-1.4/src/java/org/apache/solr/handler/ReplicationHandler.java $";
  }
    ...
    if (enableMaster) {
      ...
      if (replicateAfter.contains("startup")) {
        ...
        try {
          ...
          }else if(core.getUpdateHandler() instanceof AlfrescoUpdateHandler){
        	  LOG.info("edu-sharing customization allow AlfrescoUpdateHandler");
        	  ((AlfrescoUpdateHandler) core.getUpdateHandler()).forceOpenWriter();
          }else {
