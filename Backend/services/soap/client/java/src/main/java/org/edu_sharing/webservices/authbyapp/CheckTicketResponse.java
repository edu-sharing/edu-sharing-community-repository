...
public class CheckTicketResponse  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://authbyapp.webservices.edu_sharing.org", ">checkTicketResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("checkTicketReturn");
        elemField.setXmlName(new javax.xml.namespace.QName("http://authbyapp.webservices.edu_sharing.org", "checkTicketReturn"));
