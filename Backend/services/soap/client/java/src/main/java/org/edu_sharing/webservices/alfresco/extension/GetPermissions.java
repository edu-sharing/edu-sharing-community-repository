...
public class GetPermissions  implements java.io.Serializable {
    ...
    /**
     * Gets the nodeId value for this GetPermissions.
     * 
     * @return nodeId
     */
    ...
    /**
     * Sets the nodeId value for this GetPermissions.
     * 
     * @param nodeId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://extension.alfresco.webservices.edu_sharing.org", ">getPermissions"));
