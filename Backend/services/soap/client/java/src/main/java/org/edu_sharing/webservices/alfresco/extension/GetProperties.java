...
public class GetProperties  implements java.io.Serializable {
    ...
    /**
     * Gets the nodeId value for this GetProperties.
     * 
     * @return nodeId
     */
    ...
    /**
     * Sets the nodeId value for this GetProperties.
     * 
     * @param nodeId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://extension.alfresco.webservices.edu_sharing.org", ">getProperties"));
