...
public interface CheckedFunction<T, R, E extends Throwable> {
     ...
     */
    static <T, R, E extends Throwable> Function<T, R> wrap(CheckedFunction<T, R, E> checkedFunction) {
        return t -> {
            try {
    ...
    static <T, R, E extends Throwable, ER extends RuntimeException> Function<T, R> wrapOrThrow(CheckedFunction<T, R, E> checkedFunction, Function<Throwable, ER> exceptionHandler) {
        return t -> {
            try {
                return checkedFunction.apply(t);
            } catch (Throwable e) {
     ...
     */
    static <T, R, E extends Throwable> Function<T, R> wrap(CheckedFunction<T, R, E> checkedFunction, R defaultValue) {
        return t -> {
            try {
                return checkedFunction.apply(t);
            } catch (Throwable e) {
