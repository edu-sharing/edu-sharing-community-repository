...
public class SearchServiceLAppsImpl extends SearchServiceAdapter {
    ...
    public SearchResultNodeRef search(MetadataSet mds, String query, Map<String, String[]> criterias,
        ...
        try {
            ...
            SearchResultNodeRef result = searchLApps(appInfo.getAppId(), appInfo.getApiKey(), uri);
            ...
            is.close();
            throw new Exception("Error from LearningApp: " + connection.getResponseCode() + " " + responseStrBuilder);
        } catch (Throwable t) {
