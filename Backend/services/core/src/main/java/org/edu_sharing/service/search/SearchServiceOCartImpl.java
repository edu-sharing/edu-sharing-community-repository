...
public class SearchServiceOCartImpl extends SearchServiceAdapter {
    ...
    public SearchResultNodeRef searchOCA(String repositoryId, String path) throws Exception {
...
//			properties.put(CCConstants.LOM_PROP_TECHNICAL_FORMAT, mimetyp);
        properties.put(CCConstants.CONTENTURL, URLTool.getRedirectServletLink(currentApplicationInfo.getAppId(), id));
        properties.put(CCConstants.REPOSITORY_ID, currentApplicationInfo.getAppId());
        properties.put(CCConstants.NODETYPE, CCConstants.CCM_TYPE_IO);
...
//					contenturl = OCA_API+contenturl;
                    ...
                    properties.put(CCConstants.CCM_PROP_IO_WWWURL, url);
                    //				properties.put(CCConstants.LOM_PROP_TECHNICAL_FORMAT, mimetyp);
                    properties.put(CCConstants.CONTENTURL, URLTool.getRedirectServletLink(currentApplicationInfo.getAppId(), nodeId));
                }
            }
...
//&amount=20&page=2
            ...
            ApplicationInfo currentApplicationInfo = ApplicationInfoContextHolder.getCurrentApplicationInfo();
            return searchOCA(currentApplicationInfo.getAppId(), uri);
