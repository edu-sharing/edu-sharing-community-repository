...
public class NotificationApi {
    ...
    public Response getConfig(@Context HttpServletRequest req) throws DAOException {
        try {
            return Response.ok(notificationService.getConfig()).build();
        } catch (Throwable t) {
    ...
    public Response getNotifications(
        ...
        try {
            ...
            return Response.ok(new NotificationResponsePage(notificationService.getNotifications(receiverId, status, pageRequest))).build();
        } catch (Throwable t) {
            throw DAOException.mapping(t);
        }
    }
    ...
    public Response updateNotificationStatus(
        ...
        try {
            return Response.ok(notificationService.setNotificationStatusByNotificationId(id, status)).build();
        } catch (Throwable t) {
            throw DAOException.mapping(t);
        }
    }
    ...
    public Response updateNotificationStatusByReceiverId(
        ...
        try {
            notificationService.setNotificationStatusByReceiverId(receiverId, oldStatus, newStatus);
            return Response.ok().build();
        } catch (Throwable t) {
            throw DAOException.mapping(t);
        }
