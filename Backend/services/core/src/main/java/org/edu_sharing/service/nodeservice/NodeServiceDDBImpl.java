...
public class NodeServiceDDBImpl extends NodeServiceAdapterCached {
    ...
    public Map<String, Object> getProperties(String storeProtocol, String storeId, String nodeId) throws Throwable {
        ...
        try {
            ...
            // fetch binary info
            String all = SearchServiceDDBImpl.httpGet(SearchServiceDDBImpl.DDB_API + "/items/" + nodeId + "?oauth_consumer_key=" + URLEncoder.encode(appInfo.getApiKey(), StandardCharsets.UTF_8), new HashMap<>() {{
