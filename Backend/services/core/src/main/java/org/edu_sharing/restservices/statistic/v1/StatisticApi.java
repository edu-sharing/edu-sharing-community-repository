...
public class StatisticApi {
    ...
    @GET
    @Path("/statistics/nodes/user/{userId}")
    @Operation(summary = "get statistics for node actions of nodes owned by the given user", description = "requires toolpermission " + CCConstants.CCM_VALUE_TOOLPERMISSION_USER_STATISTICS_NODES)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = RestConstants.HTTP_200, content = @Content(schema = @Schema(implementation = TrackingNode[].class))),
            @ApiResponse(responseCode = "400", description = RestConstants.HTTP_400, content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = "401", description = RestConstants.HTTP_401, content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @POST
    @Path("/statistics/nodes/range")
    @Operation(summary = "get statistics for node actions for the given nodes", description = "requires toolpermission " + CCConstants.CCM_VALUE_TOOLPERMISSION_SELECTIVE_STATISTICS_NODES)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = RestConstants.HTTP_200, content = @Content(schema = @Schema(implementation = TrackingNode[].class))),
            @ApiResponse(responseCode = "400", description = RestConstants.HTTP_400, content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = "401", description = RestConstants.HTTP_401, content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
