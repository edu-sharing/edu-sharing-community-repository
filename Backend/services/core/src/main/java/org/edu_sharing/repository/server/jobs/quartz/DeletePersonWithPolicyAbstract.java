...
public class DeletePersonWithPolicyAbstract extends AbstractInterruptableJob{
	 ...
	 * @return
	 */
	protected PersonDeleteOptions shouldDelete(PersonDao personDao) {return null;}
