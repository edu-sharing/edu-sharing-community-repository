...
public class CollectionDao {
    ...
    public static CollectionBaseEntries getCollectionsReferences(RepositoryDao repoDao, String parentId, Filter filter, SortDefinition sortDefinition, int skipCount, int maxItems) throws DAOException {
        try {
            ...
            return getCollectionsChildren(repoDao, parentId, null, false, false, filter, List.of("files"), sortDefinition, skipCount, maxItems);
        } catch (Exception e) {
            throw DAOException.mapping(e);
        }
    }
    ...
    public static CollectionBaseEntries getCollectionsSubcollections(RepositoryDao repoDao, String parentId, SearchScope scope, boolean fetchCounts, boolean resolveInheritedAccess, Filter filter, SortDefinition sortDefinition, int skipCount, int maxItems) throws DAOException {
        try {
            return getCollectionsChildren(repoDao, parentId, scope, fetchCounts, resolveInheritedAccess, filter, List.of("folders"), sortDefinition, skipCount, maxItems);
        } catch (Exception e) {
            throw DAOException.mapping(e);
        }
    }

    private static CollectionBaseEntries getCollectionsChildren(RepositoryDao repoDao, String parentId, SearchScope scope, boolean fetchCounts, boolean resolveInheritedAccess, Filter propFilter, List<String> filter, SortDefinition sortDefinition, int skipCount, int maxItems) throws DAOException {
        try {
            NodeDao parentNode;
