...
public class UserCache {
    ...
    private final SimpleCache<String, User> eduSharingUserCache;
    ...
    public final User get(String username) {
        ...
        return eduSharingUserCache.get(username);
    }

    public final void put(String username, User user) {
        if (username == null) return;
        eduSharingUserCache.put(username, user);
    }

    public final void refresh(String username) {
        if (username == null) return;
        eduSharingUserCache.remove(username);
    }
