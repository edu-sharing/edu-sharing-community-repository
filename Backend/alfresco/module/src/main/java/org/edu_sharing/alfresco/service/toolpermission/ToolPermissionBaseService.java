...
public class ToolPermissionBaseService {
    ...
    public List<String> getAllDefaultAllowedToolpermissions(){
        ...
        toInit.remove(CCConstants.CCM_VALUE_TOOLPERMISSION_SELECTIVE_STATISTICS_NODES);
        toInit.remove(CCConstants.CCM_VALUE_TOOLPERMISSION_USER_STATISTICS_NODES);
        toInit.remove(CCConstants.CCM_VALUE_TOOLPERMISSION_ORGANIZATION_STATISTICS_NODES);
        ...
        toInit.remove(CCConstants.CCM_VALUE_TOOLPERMISSION_CREATE_ELEMENTS_ASSIGNMENTS);
    ...
    public List<String> getAllPredefinedToolPermissions(){
        ...
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_ADD_TO_PUBLIC_COLLECTION);
        ...
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_SELECTIVE_STATISTICS_NODES);
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_USER_STATISTICS_NODES);
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_ORGANIZATION_STATISTICS_NODES);
        ...
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_BAPI);
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_EDITORIAL_SUGGESTIONS);
        toInit.add(CCConstants.CCM_VALUE_TOOLPERMISSION_METADATA_METHODOLOGY);
