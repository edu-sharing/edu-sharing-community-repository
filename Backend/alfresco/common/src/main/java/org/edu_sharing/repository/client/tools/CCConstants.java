...
public class CCConstants {
	...
	// creative commons licenses URL formats :  https://creativecommons.org/licenses/{license-properties}/{version}/{jurisdiction}/deed.{locale}
	...
	public final static String COMMON_LICENSE_CC_BY_LINK = "https://creativecommons.org/licenses/by/${version}/${jurisdiction}/deed.${locale}";
	public final static String COMMON_LICENSE_CC_BY_SA_LINK = "https://creativecommons.org/licenses/by-sa/${version}/${jurisdiction}/deed.${locale}";
	public final static String COMMON_LICENSE_CC_BY_ND_LINK = "https://creativecommons.org/licenses/by-nd/${version}/${jurisdiction}/deed.${locale}";
	public final static String COMMON_LICENSE_CC_BY_NC_LINK = "https://creativecommons.org/licenses/by-nc/${version}/${jurisdiction}/deed.${locale}";
	public final static String COMMON_LICENSE_CC_BY_NC_SA_LINK = "https://creativecommons.org/licenses/by-nc-sa/${version}/${jurisdiction}/deed.${locale}";
	public final static String COMMON_LICENSE_CC_BY_NC_ND_LINK = "https://creativecommons.org/licenses/by-nc-nd/${version}/${jurisdiction}/deed.${locale}";
