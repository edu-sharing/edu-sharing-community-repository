...
public class MdsDaoV2 {
	...
	public Suggestions getSuggestions(String queryId,String parameter,String value, SearchParameters searchParameters) throws DAOException{
		...
		try{
			List<? extends SuggestOracle.Suggestion>  suggestions =		
					MetadataSearchHelper.getSuggestions(this.repoDao.getId(), mds, queryId, parameter, value, searchParameters);
