...
public class ValuespaceProviderSchoolContextTypeOfSchool implements ValuespaceProvider {
	...
	public List<MetadataSetValueKatalog> getValuespace() {
		...
		try {
			...
			HashMap<String, String> tosMap = vals.getTypeOfSchool();

			for (Map.Entry<String, String> entry : tosMap.entrySet()) {
