...
public interface PermissionService {
	...
	public void addPermissions(String _nodeId, HashMap<String,String[]> _authPerm, 
			...
			Boolean _sendCopy, Boolean createHandle, HandleMode handleMode) throws Throwable;
	...
	public void setPermissions(String nodeId, List<ACE> aces, Boolean inheritPermissions,
							   String mailText, Boolean sendMail, Boolean sendCopy, Boolean createHandle, HandleMode handleMode) throws Throwable;
